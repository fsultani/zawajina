...
nnoremap  :Vex
nnoremap t :Files
nnoremap C :let @+ = expand('%:p')
noremap y "*y
noremap [1;10D v0
noremap [1;10C v$<Left>
nnoremap ' 0 :s/^/"
vnoremap / :call Uncomment(line("."))
nnoremap / :call Uncomment(line("."))
nnoremap p 3l :vertical resize 150
nnoremap l w
nnoremap f w
nnoremap h b
nnoremap b b
...
nnoremap m iconsole.log()<Left><Left>
nnoremap <C-W> :call OpenFileInExplorer(expand('%:p'))
nnoremap  :call OpenFileInExplorer(expand('%:p'))
vnoremap  :s/^/\/\/ 
nnoremap  :s/^/\/\/ 
...
noremap <C-T><C-F> :Autoformat
nnoremap <C-T><C-B> :Buffers
nnoremap <C-H> 0
nnoremap <C-L> $
vnoremap <C-_> :s/^/\/\/ 
nnoremap <C-_> :s/^/\/\/ 
nnoremap <C-V><C-E> :Vex
vmap <BS> "-d
vmap <D-x> "*d
vmap <D-c> "*y
vmap <D-v> "-d"*P
...
inoremap f w
inoremap s :w
inoremap m console.log()<Left><Left>
inoremap kj 
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set runtimepath=~/.vim,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-autoformat,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=2
set smartindent
...
argglobal
%argdel
$argadd client/views/app/profile/js/editProfile.js
$argadd client/views/app/profile/js/handleSaveProfileChanges.js
$argadd server/routes/user.js
set stal=2
tabnew
tabnew
tabrewind
edit client/views/app/profile/js/editProfile.js
...
normal! 0
tabnext
edit client/views/app/profile/js/handleSaveProfileChanges.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
argglobal
2argu
balt client/views/app/profile/js/editProfile.js
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
tabnext 1
set stal=1
badd +1 client/views/app/profile/js/editProfile.js
badd +0 client/views/app/profile/js/handleSaveProfileChanges.js
badd +0 server/routes/user.js
