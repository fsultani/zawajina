const image1 = document.querySelector('.image-0');
const customButton1 = document.querySelector('.custom-button-0');
const imageUpload1 = document.querySelector('.image-upload-0');
const imagePreview1 = document.querySelector('.image-preview-0');
const removeImageButton1 = document.querySelector('.remove-image-0');
const processingBar1 = document.querySelector('.processing-bar-0');
const successBox1 = document.querySelector('.success-box-0');
...
image1.addEventListener('change', event => {
  ...
  imageUpload1.classList.add('display-image-0');
...
removeImageButton1.addEventListener('click', event => {
  ...
  imageUpload1.classList.remove('display-image-0');
...
const image2 = document.querySelector('.image-1');
const customButton2 = document.querySelector('.custom-button-1');
const imageUpload2 = document.querySelector('.image-upload-1');
const imagePreview2 = document.querySelector('.image-preview-1');
const removeImageButton2 = document.querySelector('.remove-image-1');
const processingBar2 = document.querySelector('.processing-bar-1');
const successBox2 = document.querySelector('.success-box-1');
...
image2.addEventListener('change', event => {
  ...
  imageUpload2.classList.add('display-image-1');
...
removeImageButton2.addEventListener('click', event => {
  ...
  imageUpload2.classList.remove('display-image-1');
...
const image3 = document.querySelector('.image-2');
const customButton3 = document.querySelector('.custom-button-2');
const imageUpload3 = document.querySelector('.image-upload-2');
const imagePreview3 = document.querySelector('.image-preview-2');
const removeImageButton3 = document.querySelector('.remove-image-2');
const processingBar3 = document.querySelector('.processing-bar-2');
const successBox3 = document.querySelector('.success-box-2');
...
image3.addEventListener('change', event => {
  ...
  imageUpload3.classList.add('display-image-2');
...
removeImageButton3.addEventListener('click', event => {
  ...
  imageUpload3.classList.remove('display-image-2');
...
const image4 = document.querySelector('.image-3');
const customButton4 = document.querySelector('.custom-button-3');
const imageUpload4 = document.querySelector('.image-upload-3');
const imagePreview4 = document.querySelector('.image-preview-3');
const removeImageButton4 = document.querySelector('.remove-image-3');
const processingBar4 = document.querySelector('.processing-bar-3');
const successBox4 = document.querySelector('.success-box-3');
...
image4.addEventListener('change', event => {
  ...
  imageUpload4.classList.add('display-image-3');
...
removeImageButton4.addEventListener('click', event => {
  ...
  imageUpload4.classList.remove('display-image-3');
...
const image5 = document.querySelector('.image-4');
const customButton5 = document.querySelector('.custom-button-4');
const imageUpload5 = document.querySelector('.image-upload-4');
const imagePreview5 = document.querySelector('.image-preview-4');
const removeImageButton5 = document.querySelector('.remove-image-4');
const processingBar5 = document.querySelector('.processing-bar-4');
const successBox5 = document.querySelector('.success-box-4');
...
image5.addEventListener('change', event => {
  ...
  imageUpload5.classList.add('display-image-4');
...
removeImageButton5.addEventListener('click', event => {
  ...
  imageUpload5.classList.remove('display-image-4');
...
const image6 = document.querySelector('.image-5');
const customButton6 = document.querySelector('.custom-button-5');
const imageUpload6 = document.querySelector('.image-upload-5');
const imagePreview6 = document.querySelector('.image-preview-5');
const removeImageButton6 = document.querySelector('.remove-image-5');
const processingBar6 = document.querySelector('.processing-bar-5');
const successBox6 = document.querySelector('.success-box-5');
...
image6.addEventListener('change', event => {
  ...
  imageUpload6.classList.add('display-image-5');
...
removeImageButton6.addEventListener('click', event => {
  ...
  imageUpload6.classList.remove('display-image-5');
