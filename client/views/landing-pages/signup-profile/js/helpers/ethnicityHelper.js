    ...
    const results = resultsData =>
      resultsData
        .map((response, index) => {
          ...
          return `
              <div class='flex flex-justify-content-flex-start flex-wrap user-selection-wrapper display-user-ethnicity' id='wrapper-${index}'>
                <div class='user-selection-content user-ethnicity-content' id='${ethnicity}'><p>${ethnicity}</p></div>
                <div class='user-selection-remove-wrapper'>
                  <span role='img' aria-label='close' class='user-selection-remove user-ethnicity-remove' id='remove-ethnicity-${index}'>
                    <svg viewBox='64 64 896 896' focusable='false' data-icon='close' width='100%' height='100%' fill='currentColor' aria-hidden='true'>
