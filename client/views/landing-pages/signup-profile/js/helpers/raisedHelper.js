(() => {
  ...
  const renderCountry = country => {
    ...
    const result = `
      <div class='flex flex-justify-content-flex-start flex-wrap user-selection-container'>
        <div class='user-selection-wrapper display-country'>
          <div class='user-selection-content user-country-content'><p>${countryName}</p></div>
