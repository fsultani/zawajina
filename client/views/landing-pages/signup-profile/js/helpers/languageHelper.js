    ...
    const results = resultsData =>
      resultsData
        .map((response, index) => {
          ...
          return `
              <div class='flex flex-justify-content-flex-start flex-wrap user-selection-wrapper display-user-language' id='wrapper-${index}'>
                <div class='user-selection-content user-language-content' id='${language}'><p>${language}</p></div>
