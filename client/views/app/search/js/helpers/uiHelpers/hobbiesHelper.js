  ...
  hobbies.map(item => hobbiesOptionsHTML.push(`
    <div class='form-check'>
      <label class='form-check-label' for='${item}'>
        <input class='form-check-input hobbies-input' onclick='handleHobbiesClick("${item}")' type='checkbox' id='${item}'>
        ${item}
      </label>
    </div>
  `));
...
(() => {
  ...
  const getAllHobbies = userInput => {
    const filteredResults = hobbiesList.filter(
  ...
  hobbiesInput.addEventListener(
    ...
    debounce(async event => {
      ...
      const results = getAllHobbies(userInput);
